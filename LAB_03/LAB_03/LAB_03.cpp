...
glm::vec3 gold_ambient = { 0.24725,0.2245,0.0645 }, gold_diffuse = { 0.34615,0.3143,0.0903 }, gold_specular{ 0.797357,0.723991,0.208006 }; GLfloat gold_shininess = 83.2f;
...
void moveCameraLeft()
{
	...
	glm::vec3 sideDirection = slide_vector * CAMERA_TRASLATION_SPEED * 10.0f;
